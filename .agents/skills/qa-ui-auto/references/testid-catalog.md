# NewMob UI testid catalog (canonical)
...
## Gap-coverage components (added in P3)

These were originally untested; testids were added to make them addressable.

### Window chrome
- `[data-testid="app-titlebar"]` - main app title bar
- `[data-testid="window-controls"]` - container for min/max/close
- `[data-testid="window-min"]` / `[data-testid="window-max"]` / `[data-testid="window-close"]` - individual buttons
- `[data-testid="titlebar-tray"]` - container for theme + compact toggle
- `[data-testid="theme-cycle"]` - cycle Light/Dark/Follow system
- `[data-testid="compact-toggle"]` - enter/exit compact mode

### Terminal extensions
- `[data-testid="multiexec-bar"]` - MultiExec broadcast bar
- `[data-testid="multiexec-input"]` - the broadcast textarea
- `[data-testid="commands-palette"]` - common commands modal
- `[data-testid="commands-search"]` - palette filter input
- `[data-testid="commands-list"]` - palette result list

### Capture
- `[data-testid="capture-toolbar"]` - capture toolbar root (any context)
- `[data-testid="capture-menu"]` - the camera dropdown trigger

### Z-modem conflict
- `[data-testid="zmodem-conflict"]` - conflict dialog root
- `[data-testid="zmodem-overwrite"]` / `[data-testid="zmodem-rename"]` / `[data-testid="zmodem-skip"]` - choices

### VNC
- `[data-testid="vnc-panel"]` - panel container
- `[data-testid="vnc-canvas"]` - render canvas
- `[data-testid="vnc-floating-toolbar"]` - floating toolbar (already present)
